                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="abouttext" cols="30" rows="10"><?= getaboutme()->abouttext ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Email:</label>
                            <input type="text" class="form-control" name="email" value="<?= getaboutme()->email ?>">
                        </div>
                        <div class="form-group">
                            <label>Telefon:</label>
                            <input type="text" class="form-control" name="tel" value="<?= getaboutme()->tel ?>">
                        </div>
                        <div class="form-group">
                            <label>Yaş:</label>
                            <input type="text" class="form-control" name="age" value="<?= getaboutme()->age ?>">
                        </div>
                        <div class="form-group">
